...
class SearchResponse(_message.Message):
    __slots__ = ("results", "page_number", "has_next")
    ...
    page_number: int
    has_next: bool
    def __init__(self, results: _Optional[_Iterable[_Union[SearchResponse.Result, _Mapping]]] = ..., page_number: _Optional[int] = ..., has_next: _Optional[bool] = ...) -> None: ...
